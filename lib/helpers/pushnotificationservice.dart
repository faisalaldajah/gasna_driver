...
import 'package:gasna_driver/widgets/NotificationDialog.dart';
  ...
  void fetchRideInfo(String rideID, context) {
    ...
    rideRef.once().then((DataSnapshot snapshot) {
      ...
      if (snapshot.value != null) {
        ...
        int numberOfGass = snapshot.value['number_of_gas'];
        var promoCde = snapshot.value['promo_code'];
        var finishCode =snapshot.value['finish_code'];
        ...
        tripDetails.numberOfGass = numberOfGass;
        tripDetails.finishCode=finishCode;
        numberOfGas = numberOfGass;
        thePromoCode = promoCde;
        //TODO
